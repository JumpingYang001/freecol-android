...
import org.freecolandroid.repackaged.java.awt.FontMetrics;
...
import org.freecolandroid.repackaged.java.awt.Stroke;
...
import org.freecolandroid.repackaged.java.awt.geom.Ellipse2D;
...
import org.freecolandroid.repackaged.java.awt.geom.RoundRectangle2D;
...
public final class MapViewer {
	...
	private List<MapViewerListener> listeners = new ArrayList<MapViewer.MapViewerListener>();
    ...
    */
    public MapViewer(FreeColClient freeColClient, GUI gui, Dimension size, ImageLibrary lib) {
        ...
        cursor = new net.sf.freecol.client.gui.TerrainCursor(freeColClient);
...
//        }
    ...
    */
    public boolean setActiveUnit(Unit activeUnit) {
        ...
        SwingUtilities.invokeLaterOnUiThread(new Runnable() {
			...
			@Override
			public void run() {
				for (MapViewerListener l : listeners) {
		        	l.onUnitSelected(MapViewer.this.activeUnit);
		        }
			}
		});
    ...
    */
    public void startGoto() {
        gotoStarted = true;
        gui.getCanvas().setCursor((org.freecolandroid.repackaged.java.awt.Cursor) UIManager.get("cursor.go"));
        setGotoPath(null);
    }
...
//        FCLog.log("firstRow=" + firstRow + ", lastRow=" + lastRow + ", firstCol=" + firstColumn + ", lastCol=" + lastColumn);
//        FCLog.log("clip x=" + clipBounds.x + ", y=" + clipBounds.y +", w=" + clipBounds.width + ", h=" + clipBounds.height);
...
//        FCLog.log("Number of tiles drawn=" + count);
