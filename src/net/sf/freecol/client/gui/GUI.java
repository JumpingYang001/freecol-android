...
import org.freecolandroid.ui.menu.MainMenuFragment;
import org.freecolandroid.ui.menu.NewGameFragment;
import org.freecolandroid.ui.menu.SplashScreenFragment;
import org.freecolandroid.ui.menu.StartGameFragment;
...
//        return canvas.showInputDialog(tile, text, defaultValue, okText, cancelText, rejectEmptyString);
    ...
    public void startGUI(Dimension innerWindowSize,
        ...
        if (!isWindowed()) {
            Log.d("GUI","is not Windowed");
            if (!gd.isFullScreenSupported()) {
                Log.d("GUI","not support full screen!");
                 ...
                 * GraphicsDevice! Using windowed mode instead.");
                 */
                //windowed = true;
                //setWindowed(true);
