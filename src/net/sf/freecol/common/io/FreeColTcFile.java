...
public class FreeColTcFile extends FreeColModFile {
    ...
    */
    ...
    public static File getRulesDirectory() {
    	System.out.println("FreeColTcFile.getRulesDirectory()");
    	System.out.println("Datadir=" + FreeCol.getDataDirectory());
//        if(FreeCol.getDataDirectory().exists())
//        {
//            System.out.println(FreeCol.getDataDirectory() +  " exist!");
//        }
//        else
//        {
//            System.out.println(FreeCol.getDataDirectory() +  " not exist!");
//        }
    	System.out.println("TcFiledDir=" + FreeCol.getDataDirectory() + "/" + DIRECTORY);
        File file = new File(FreeCol.getDataDirectory(), DIRECTORY);
//        if(file.exists())
//        {
//            System.out.println(FreeCol.getDataDirectory() + "/" +DIRECTORY + " exist!");
//        }
//        else
//        {
//            System.out.println(FreeCol.getDataDirectory() + "/" +DIRECTORY + " not exist!");
//        }
        return file;
    }
